 ...
 * @version    $Id: Encoding.php 1454 2020-04-16 09:29:31Z jan.slabon $
 */
...
class SetaPDF_Core_Encoding
{
  /* PDF specific predefined encodings */
    ...
    static public function getPredefinedEncodingTable($encoding)
    {
        ...
        switch ($encoding) {
            ...
            case 'Symbol':
                ...
                return call_user_func([$className, 'getTable']);
        }
    ...
    static public function convertPdfString($string, $outEncoding = 'UTF-8')
    {
        ...
        return self::convert($string, $inEncoding, $outEncoding . '//TRANSLIT');
    }
