 ...
 * @version    $Id: Path.php 1409 2020-01-30 14:40:05Z jan.slabon $
 */
...
class SetaPDF_Core_Canvas_Path extends SetaPDF_Core_Canvas_StandardOperators
{
     ...
     * @return SetaPDF_Core_Canvas_Path
     */
    public function setDashPattern(array $dashesAndGaps = [], $phase = 0)
    {
  ...
  /** Path Construction methods **/
    ...
    public function curveTo($x1, $y1, $x2, $y2, $x3 = null, $y3 = null)
    {
        ...
        if ($x3 !== null && is_numeric($x3) && $y3 !== null && is_numeric($y3)) {
