 ...
 * @version    $Id: GraphicState.php 1409 2020-01-30 14:40:05Z jan.slabon $
 */
...
class SetaPDF_Core_Canvas_GraphicState
{
    ...
    public function restore()
    {
        if (count($this->_stack) === 1) {
            throw new BadMethodCallException('Graphic state would be empty!');
        }
