 ...
 * @version    $Id: CrossReferenceTable.php 1411 2020-01-30 15:20:24Z jan.slabon $
 */
...
class SetaPDF_Core_Document_CrossReferenceTable
{
    ...
    {
        if (isset($this->_objectOffsets[$objectId][$generation])) {
    ...
    )
    {
        ...
        $buildEntry = static function($data) use (&$entryLengths) {
