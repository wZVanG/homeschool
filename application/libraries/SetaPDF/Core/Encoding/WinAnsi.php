 ...
 * @version    $Id: WinAnsi.php 1409 2020-01-30 14:40:05Z jan.slabon $
 */
 ...
 * @license    https://www.setasign.com/ Commercial
 */
class SetaPDF_Core_Encoding_WinAnsi
    implements SetaPDF_Core_Encoding_EncodingInterface
{
    static public $table = [
        "\x20\x22" => ["\x95", "\x7f", "\x81", "\x8d", "\x8f", "\x90", "\x9d"], // bullet
        "\x00\x20" => ["\x20", "\xa0"], // space
        "\x00\xad" => "\xad", // softhyphen
        "\x00\x41" => "\x41", // A
        "\x00\xc6" => "\xc6", // AE
        "\x00\xc1" => "\xc1", // Aacute
        ...
        "\x20\x39" => "\x8b", // guilsinglleft
        "\x20\x3a" => "\x9b", // guilsinglright
        "\x00\x68" => "\x68", // h
        "\x00\x2d" => "\x2d", // hyphen
        "\x00\x69" => "\x69", // i
        "\x00\xed" => "\xed", // iacute
        ...
        "\x20\x1e" => "\x84", // quotedblbase
        "\x20\x1c" => "\x93", // quotedblleft
        "\x20\x1d" => "\x94", // quotedblright
        "\x20\x18" => "\x91", // quoteleft
        "\x20\x19" => "\x92", // quoteright
        "\x20\x1a" => "\x82", // quotesinglbase
    ...
    /**
     * TODO: The hyphen character is also encoded as 255 in WinAnsiEncoding. The meaning
     * of this duplicate code shall be “soft hyphen,” but it shall be typographically
     * the same as hyphen.
     *
     * Notice: Should we really care about this?
     */
    ...
    {
        /**
         * TODO: In WinAnsiEncoding, all unused codes greater than 40 map to the bullet
         * character. However, only code 225 (0x2022) shall be specifically assigned to the
