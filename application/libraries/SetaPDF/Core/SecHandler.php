...
abstract class SetaPDF_Core_SecHandler
{
    ...
    static public function arcfour($key, $data)
    {
        ...
        if (self::$engine === 'openssl' && function_exists('openssl_encrypt')) {
    ...
    static public function generateRandomBytes($length)
    {
        ...
        if (function_exists('openssl_random_pseudo_bytes')) {
            ...
            if ($bytes === false) {
                throw new SetaPDF_Core_SecHandler_Exception('Unable to create random bytes.');
            }
            return $bytes;
        }
