angular.module('app').controller("PeriodosMatriculasCtrl", ["$scope", "API", "WAIUtils", "$compile", "Callbacks", function($scope, API, WAIUtils, $compile, Callbacks){

	$scope.module_name = "periodos_matriculas";
