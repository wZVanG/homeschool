angular.module('app').controller("PeriodosDetallesCtrl", ["$scope", "API", "WAIUtils", "$compile", "Callbacks", function($scope, API, WAIUtils, $compile, Callbacks){

	$scope.module_name = "periodos_detalles";

	$scope.info = {
		title: "Periodos_detalles"
	};
